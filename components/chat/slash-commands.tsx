...
export const slashCommands: SlashCommand[] = [
  {
    name: "new",
    description: "Start a new scan session",
    icon: <PenSquareIcon className="size-3.5" />,
    action: "new",
  },
  {
    name: "clear",
    description: "Clear current scan session",
    icon: <Trash2Icon className="size-3.5" />,
    action: "clear",
  },
  {
    name: "rename",
    description: "Rename current scan session",
  ...
  {
    name: "delete",
    description: "Delete current scan session",
    icon: <XIcon className="size-3.5" />,
    action: "delete",
  },
  {
    name: "purge",
    description: "Delete all scan sessions",
